  ...
  return (
    <div className="max-w-4xl mx-auto p-6 min-h-screen">
      <header className="mb-2">
        <Link
          href="/dashboard"
          className="text-white/50 hover:text-primary transition-colors flex items-center gap-2 mb-6 w-fit text-sm font-medium"
        >
        ...
        <p className="text-white/50 mt-2">
          Comprehensive history of all automated actions and agent activities.
        </p>
      </header>
        ...
        {loading ? (
          <div className="space-y-6">
            {[1, 2, 3, 4, 5, 6, 7].map((i) => (
              <div
                key={i}
                className="animate-pulse flex items-center gap-4 pb-6 border-b border-white/5 last:border-0"
              >
