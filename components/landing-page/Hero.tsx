...
export default function Hero() {
  return (
    <section className="relative pt-20 pb-18 md:pt-32 md:pb-26 px-6 overflow-hidden">
      {/* Background orbs */}
      ...
      <div className="max-w-5xl mx-auto flex flex-col items-center text-center relative z-10">
        ...
        <h1 className="mb-8 opacity-0 animate-[premium-fade-in_1s_cubic-bezier(0.16,1,0.3,1)_forwards] [animation-delay:400ms]">
          <span className="block text-5xl sm:text-6xl md:text-7xl lg:text-[5.5rem] font-bold tracking-tight leading-[1.08]">
            Your Personal
          </span>
          <span className="block text-5xl sm:text-6xl md:text-7xl lg:text-[5.5rem] font-bold tracking-tight leading-[1.08] mt-2 bg-clip-text text-transparent bg-linear-to-b from-white via-white/90 to-gray-500">
            Autonomous Agent
          </span>
        </h1>

        {/* Sub-headline */}
        <p className="text-lg md:text-xl text-gray-400 max-w-xl mb-14 opacity-0 animate-[premium-fade-in_1s_cubic-bezier(0.16,1,0.3,1)_forwards] [animation-delay:600ms] leading-relaxed font-light">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 opacity-0 animate-[premium-fade-in_1s_cubic-bezier(0.16,1,0.3,1)_forwards] [animation-delay:800ms]">
          <Link
            href="/setup"
            className="group h-14 px-8 rounded-2xl bg-primary text-black font-bold text-base flex items-center gap-2.5 hover:scale-[1.03] active:scale-[0.98] transition-all duration-300 shadow-[0_0_40px_rgba(16,185,129,0.25)]"
          >
            Start Automating
